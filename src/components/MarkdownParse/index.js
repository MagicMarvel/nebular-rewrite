            ...
            <ReactMarkdown
                ...
                text-gray-500 rounded bg-gray-400 bg-opacity-30 px-1.5 w-full py-1
                 overflow-x-auto break-all`}
                    ...
                    h2: ({ node, ...props }) => (
                        <h2
                            className="text-gray-500 font-kaiti text-2xl my-4"
                            {...props}
                        >
                            {props.children}
                        </h2>
                    ...
                    h3: ({ node, ...props }) => (
                        <h3
                            className="text-gray-500 font-kaiti text-xl"
                            {...props}
                        >
                            {props.children}
                        </h3>
                    ...
                    h4: ({ node, ...props }) => (
                        <h4
                            className="text-gray-500 font-kaiti text-lg"
                            {...props}
                        >
                            {props.children}
                        </h4>
                    ...
                    h5: ({ node, ...props }) => (
                        <h5
                            className="text-gray-500 font-kaiti text-base"
                            {...props}
                        >
                            {props.children}
                        </h5>
                    ...
                    table: ({ node, ...props }) => (
                        <table
                            className="border-collapse text-gray-700"
                            {...props}
                        >
                            {props.children}
                        </table>
